...
const CharacterFilter: React.FC<CharacterFilterProps> = ({
  ...
  return (
    <motion.div 
      className="p-4 sm:p-6 w-full" // Tam genişlik kullanılıyor
      initial="hidden"
      animate="visible"
    ...
    >
      ...
      {/* Filtreleme alanları - reorganized into a single row with clear button at the end */}
      <div className="grid grid-cols-5 gap-4 mb-4 max-w-6xl mx-auto">
            ...
            {nameFilter && (
              <div className="absolute inset-y-0 right-0 pr-3 flex items-center z-10">
                <button
                  ...
                  className="text-gray-400 hover:text-white transition-colors bg-gray-700/70 hover:bg-gray-600/70 rounded-full p-1"
            ...
            <div className="absolute inset-y-0 right-0 flex items-center">
              {selectedStatus && (
                <button
                  ...
                  className="text-gray-400 hover:text-white transition-colors bg-gray-700/70 hover:bg-gray-600/70 rounded-full p-1 z-10 mr-8"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400 pointer-events-none absolute right-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {/* Clear filters button - moved to the last column in the grid */}
        <motion.div variants={itemVariants} className="col-span-1 flex items-end">
          <button
            ...
            className={`w-full px-4 py-2 h-10 rounded-lg flex items-center justify-center space-x-2 transition-all duration-300
              ${hasActiveFilters 
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" 
              className={`h-5 w-5 mr-1 ${hasActiveFilters ? "text-gray-300 group-hover:text-white" : "text-gray-500"}`} 
              viewBox="0 0 20 20" 
              fill="currentColor" 
              aria-hidden="true"
            >
