...
export default function Locations() {
  ...
  return (
    <div className="min-h-screen bg-aot-dark">
      {/* Hero Banner */}
      <div className="relative h-64 md:h-80 bg-gradient-to-r from-green-900 to-green-800 flex items-center">
        <div className="absolute inset-0 bg-black/30"></div>
        <div className="aot-container relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Locations</h1>
          <p className="text-xl text-gray-200 max-w-2xl">
            Discover the key settings and environments where the story unfolds.
          </p>
        </div>
      </div>
